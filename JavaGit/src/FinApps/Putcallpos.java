...
public class Putcallpos {
    ...
    public void callprof(double callpr, double exercisepr, double stockprice) {// single data//
        double shrtcallprofit = stockprice <= exercisepr ? callpr : (callpr - (stockprice - exercisepr));
        setScallprof(shrtcallprofit);
        double lngcallprofit = stockprice <= exercisepr ? -callpr : (-callpr + (stockprice - exercisepr));
    ...
    public void callprof(double callpr, double exercisepr, double[] stockprice) {
        ...
        for (double s : stockprice) {
            shrtcallprofit[indx] = stockprice[indx] <= exercisepr ? callpr : (callpr - (stockprice[indx] - exercisepr));
            lngcallprofit[indx] = stockprice[indx] <= exercisepr ? -callpr : (-callpr + (stockprice[indx] - exercisepr));
            indx++;
        }
        setScallprof(shrtcallprofit);
        setLcallprof(lngcallprofit);
    ...
    public void putprof(double putpr, double exercisepr, double stockprice) {
        double lngputprofit = stockprice <= exercisepr ? (-putpr + (exercisepr - stockprice)) : -putpr;
        setLputprof(lngputprofit);
        double shrtputprofit = stockprice <= exercisepr ? (putpr + (exercisepr - stockprice)) : putpr;
    ...
    public void putprof(double putpr, double exercisepr, double[] stockprice) {
        ...
        int indx = 0;
        for (double s : stockprice) {
            lngputprofit[indx] = stockprice[indx] <= exercisepr ? (-putpr + (exercisepr - stockprice[indx])) : -putpr;
            shrtputprofit[indx] = stockprice[indx] <= exercisepr ? (putpr + (stockprice[indx] - exercisepr)) : putpr;
            indx++;
        }
        setLputprof(lngputprofit);
        setSputprof(shrtputprofit);
