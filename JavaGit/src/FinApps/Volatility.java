...
public class Volatility{
	...
	public void yieldForPpoint(double couponpercent,double price,double maturity,double estimate,double pointvalue)
	{
		...
		setPpointpriceup(price+change);
			...
			setInitialYldPp(CalcBond.yieLd(facevalue,couponterm,couponpercent,price,maturity));
			setdownyieldPp(Math.abs((CalcBond.yieLd(facevalue,couponterm,couponpercent,getPricedownPp(),maturity))));
			setupyieldPp(Math.abs((CalcBond.yieLd(facevalue,couponterm,couponpercent,getPriceupPp(),maturity))));				
